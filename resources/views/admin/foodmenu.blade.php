            ...
            <div class="container-fluid"> 
              ...
              <table class="table table-hover table-striped table-bordered table-dark table-responsive-sm">
                        ...
                        <tbody>
                            ...
                            <td>
                              <a type="button" class="btn btn-info btn-sm" href="{{url('/editmenu', $data->id)}}" >Update</a>
                              <a type="button" class="btn btn-danger btn-sm" href="{{url('/deletemenu', $data->id)}}" onclick="return confirm('Are you sure to delete?')">Delete</a>
                            </td>
                            </tr>
                            @endforeach
                        </tbody>
