      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <!-- form starts -->
            <form action="{{url('/upload-dinner')}}" method="post" enctype="multipart/form-data" class="form-horizontal align-items-center" style="width:40%" >
                ...
                <!-- Form Name -->
                <legend>Week's Special Dinner Items</legend>
            ...
            <div class="table-responsive mt-3">
                ...
                <div class="row">
                    <div class="col-sm-6 justify-content-start">
                        <h2>Week's Special Dinner Items List</h2>
                    </div>
                    <div class="col-sm-6">
              ...
              <table class="table table-hover table-striped table-bordered table-dark table-responsive-sm">
                        ...
                        <tbody>
                            ...
                            <td><img src="/dinner_images/{{$data->image}}" alt=""></td>
                            <td>
                              <a type="button" class="btn btn-danger btn-sm" href="{{url('/deletedinner', $data->id)}}" onclick="return confirm('Are you sure to delete?')">Delete</a>
                            </td>
                            </tr>
                            @endforeach
                        </tbody>
