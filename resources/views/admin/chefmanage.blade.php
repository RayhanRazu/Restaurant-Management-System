            ...
            <div class="container-fluid"> 
              <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="alert alert-danger">{!! $deta->links() !!}</div>
                    @endif    
                  </div>
              </div>
            </div>
              ...
              <table class="table table-hover table-striped table-bordered table-dark table-responsive-sm">
                        ...
                        <tbody>
                            ...
                            <td>
                              <a type="button" class="btn btn-info btn-sm" href="{{url('/editchef', $data->id)}}" >Update</a>
                              <a type="button" class="btn btn-danger btn-sm" href="{{url('/deletechef', $data->id)}}" onclick="return confirm('Are you sure to delete?')">Delete</a>
                            </td>
                            </tr>
                            @endforeach
                        </tbody>
